...
public class DataStorage {
    ...
    static {
        ...
        // Add bids
        lot1.addBid(new Bid(user2.getId(), lot1.getId(), new BigDecimal("550.00")));
        ...
        user1.addOwnedLot(lot1.getId());
        user1.addOwnedLot(lot2.getId());
        user2.addOwnedLot(lot3.getId());

        // Update user's bid lots
        user2.addBidLot(lot1.getId());
    }
